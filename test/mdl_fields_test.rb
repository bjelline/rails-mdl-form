...
class MdlFieldsTest < ActionView::TestCase
  ...
  test "text areas are wrapped correctly" do
    expected = %{<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><textarea class="mdl-textfield__input" id="user_comments" name="user[comments]">\nmy comment</textarea><label class="mdl-textfield__label " for="user_comments">Comments</label></div>}
    assert_equal expected, @builder.text_area(:comments)
  end

  test "text fields are wrapped correctly" do
    expected = %{<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label"><input class="mdl-textfield__input" id="user_email" name="user[email]" type="text" value="steve@example.com" /><label class="mdl-textfield__label  required" for="user_email">Email</label></div>}
