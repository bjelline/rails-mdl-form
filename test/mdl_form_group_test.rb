...
class MdlFormGroupTest < ActionView::TestCase
  ...
  #   builder = MdlForm::FormBuilder.new(:super_user, super_user, self, {})
  ...
  #   non_default_horizontal_builder = MdlForm::FormBuilder.new(:user, @user, self, { layout: :horizontal, label_col: "col-sm-3", control_col: "col-sm-9" })
